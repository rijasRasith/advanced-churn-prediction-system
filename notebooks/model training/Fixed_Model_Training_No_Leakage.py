# ===================================================================
# FIXED Model Training - No Target Leakage + Proper Validation
# ===================================================================
# Created by: Rasith Novfal S
# FIXES: Removes target leakage, adds proper validation, prevents overfitting
# This version ensures realistic model performance through proper ML practices
# ===================================================================

# CELL 1: Environment Setup and Critical Fixes
# ===================================================================
...
# ===================================================================
# CELL 2: Load and Clean Data (Remove Target Leakage)
# ===================================================================
...
def load_clean_data():
    ...
    try:
        ...
        if leakage_columns:
            ...
            print(f"\n💥 REMOVING {len(leakage_columns)} leakage columns...")
            df_clean = df.drop(columns=leakage_columns)
            print(f"   Clean data shape: {df_clean.shape}")
        else:
            print("✅ No obvious target leakage columns found")
            df_clean = df.copy()
...
# ===================================================================
# CELL 3: Proper Train-Validation-Test Split
# ===================================================================
...
# ===================================================================
# CELL 4: Feature Engineering (Applied Only on Training Data)
# ===================================================================
...
# ===================================================================
# CELL 5: Model Training with Proper Validation
# ===================================================================
...
# ===================================================================
# CELL 6: Model Performance Analysis (Realistic Results)
# ===================================================================
...
# ===================================================================
# CELL 8: Save Clean Results and Summary  
# ===================================================================
...
def save_clean_results():
    ...
    try:
        ...
        # Save best model
        model_path = 'artifacts/clean_best_model.pkl'
        ...
        results_path = 'artifacts/clean_training_results.json'
